...
def recommendation(input_text,choice):
    recommended_apis,recommended_categories=recommendation2.recommendation(input_text,int(choice))
...
if st.button("Get Recommendations"):
    if input_text:
        ...
        if size_inp>=10:
            ...
            st.write("Input description must be of at least 10 words")