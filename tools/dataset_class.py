...
class MashupDataset(Dataset):
    def __init__(self, all_api=False):
        super().__init__()
        with open(rootPath + '\MTFM\data\mashup_name.json', 'r') as f:
            self.name = json.load(f)
        with open(rootPath + '\MTFM\\data\mashup_description.json', 'r') as f:
            self.description = json.load(f)
        with open(rootPath + '\MTFM\data\mashup_category.json', 'r') as f:
            self.category = json.load(f)
        with open(rootPath + '\MTFM\data\mashup_used_api.json', 'r') as f:
            self.used_api = json.load(f)
        with open(rootPath + '\MTFM\data\category_list.json', 'r') as f:
            category_list = json.load(f)

        if all_api:
            with open(rootPath + '\\MTFM\\data\\api_name.json', 'r') as f:
                api_list = json.load(f)
        else:
            with open(rootPath + '\\MTFM\\data\\used_api_list.json', 'r') as f:
                api_list = json.load(f)
...
class ApiDataset(Dataset):
    def __init__(self, all_api=False):
        ...
        with open(rootPath + '\\MTFM\\data\\api_name.json', 'r') as f:
            name = json.load(f)
        with open(rootPath + '\\MTFM\\data\\api_description.json', 'r') as f:
            description = json.load(f)
        with open(rootPath + '\\MTFM\\data\\api_category.json', 'r') as f:
...
if __name__ == '__main__':
    ...
    # ds = F3RMDataset()
    ds = TextDataset()
    print(ds.build_vocab(ds.all_test,ds.max_vocab_size))
    # print(build_vocab())
